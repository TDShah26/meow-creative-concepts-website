...
export default function AboutUs() {
    return (
        <section id="about" className="relative py-16 md:py-24 px-4 md:px-12 bg-[#0f0f0f] overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                >
                    <h2 className="text-3xl md:text-6xl font-light mb-4 md:mb-6 leading-tight">
                    ...
                    <h3 className="text-lg md:text-2xl text-white/80 font-light max-w-3xl mx-auto px-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-20 items-center">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.8 }}
                        className="relative aspect-square w-full max-w-[280px] md:max-w-sm mx-auto rounded-2xl overflow-hidden shadow-2xl shadow-amber-900/20 group"
                    >
                    ...
                    {/* Story Text */}
                    <div className="space-y-5 md:space-y-10 text-base md:text-xl font-light text-white/85 leading-relaxed text-center md:text-left">
                        <motion.p
