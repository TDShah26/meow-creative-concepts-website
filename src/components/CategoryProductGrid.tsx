                        ...
                        {products.map((product, index) => (
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="absolute top-4 right-4 z-20 group/btn"
                                    title="Like this? Click to connect with us"
                                >
                                    <div className="relative w-10 h-10 rounded-full bg-black/40 backdrop-blur-md border border-white/10 flex items-center justify-center hover:bg-[#25D366]/20 hover:border-[#25D366]/40 transition-all duration-300 shadow-lg">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="text-white/70 group-hover/btn:text-[#25D366] transition-colors duration-300">
                                    ...
                                    {/* Tooltip */}
                                    <div className="absolute top-1/2 right-12 -translate-y-1/2 scale-0 group-hover/btn:scale-100 bg-[#0f0f0f]/90 border border-white/10 backdrop-blur-md px-3 py-1.5 rounded-lg text-[10px] sm:text-xs text-white/95 whitespace-nowrap shadow-xl transition-all duration-300 origin-right pointer-events-none">
